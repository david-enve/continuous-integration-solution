# Ansible Role: Jenkins CI Platform
...
NOTE: to see the 'admin' password you need to see the main.yml file inside cicd/roles/jenkins/defaults/main.yml in the line 'jenkins_admin_password'
